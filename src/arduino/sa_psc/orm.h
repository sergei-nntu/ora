...
#define ORM_SPEED_UPDATE_INTERVAL_MS 5   // ms // Good - 5

#define ORM_SPEED_PREDICTION_INTERVAL_MS 100
...
#define ORM_TARGET_ANGLE_TOLERANCE 100
#define ORM_TARGET_ANGLE_STABLE_ITERATIONS 10
...
const short orm_j_stepper_full_rot = 16000;  // Number of steps to reach 2*Pi Angle

const short orm_j_speed_max_default =     3000;
const short orm_j_speed_min =             400;
const short orm_j_acceleration_default =  250;

const int default_servo_zero_angle = 2700;
const int default_servo_max_angle = 28500;
...
class ORM {
  private:
    ...
    short j_speed_desired =   500; // Default Speed 11.25 degrees second. Must be populated in the constructor
    short j_speed_current =   0;
    short j_speed_read =      0;
    short j_speed_read_prev = 0;
    short j_speed_max;
    long j_accel_read = 0;
    long j_accel_prev = 0;
    short j_acceleration;
    short j_angle_desired =   0;
    short j_angle_current =   0;
    short j_angle_read =      0;
    short j_angle_read_prev = 0;
    ...
    short j_angle_read_history[HISTORY_RECORDS_N];
    short j_speed_read_history[HISTORY_RECORDS_N];
    unsigned long history_millis[HISTORY_RECORDS_N];
    int history_records_size = 0;
    int history_records_ptr = 0;
    /*
    ...
    */
    ...
    int control_pwm = 0;
    int speed_control_effort = 0;
    int impulse_debt = 0;
    int speed_diff_sign_prev = 0;
    unsigned char target_angle_stable_iterations = 0;
    int control_mode = 0;
    int min_pwm = 0;
